...
# Sprite images
SHIP_PLAYER1_IMAGE = "images/spaceship_small_red.png" # Got this from  https://opengameart.org/content/pixel-spaceship
SHIP_PLAYER2_IMAGE = "images/spaceship_small_blue.png"   # Got this from  https://opengameart.org/content/pixel-spaceship 
BACKGROUND_IMAGE = "images/cave.png"

#START_BACKGROUND = "images/cosmic_cavern.png"
#END_BACKGROUND = "images/cosm_cav_restart.png"

START_BACKGROUND = "images/cavernous_chaos.png"  #M^ VELGE EN STARTBAKGRUNN
END_BACKGROUND = "images/cav_chaos_restart.png"


OBSTACLE_IMAGE = "images/alien.png"  # Got this from https://www.vecteezy.com/png/19017599-an-8-bit-retro-styled-pixel-art-illustration-of-a-goblin 
BULLET_IMAGE = "images/bullet.png"
FUEL_IMAGE = "images/fuel_can.png"
POOF_IMAGE = "images/Poof.png" #Got this from https://opengameart.org/content/poof-effect-spritesheet 
...
#MUSIC = "sound/space2.mp3" # Music by Leigh Robinson from Pixabay: https://pixabay.com/music/ambient-lost-in-space-ambient-soundscape-12294/ 
VOLUME = 0.25
...
#CRASH_SOUND = "sound/strong-hit.mp3" #Sound Effect from Pixabay: https://pixabay.com/sound-effects/strong-hit-36455/
